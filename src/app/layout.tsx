...
export const metadata: Metadata = {
  title: "Columbia School O'quv Markazi | Tashkent - Repetitorlik va Ta'lim",  description: "Columbia School O'quv Markazi - Tashkentda eng yaxshi o'qituvchilar bilan repetitorlik, imtihon tayyorlash va til kursları. 5★ baholar. Bepul konsultatsiya.",  keywords: "o'quv markazi tashkent, repetitor tashkent, ta'lim markazi, imtihon tayyorlash, ingliz tili kursi, sergeli",  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Columbia School O'quv Markazi | Sifatli Ta'lim Tashkentda",    description: "Tashkentning eng ishonchli o'quv markazi. Professional o'qituvchilar, isbotlangan dasturlar, bepul konsultatsiya.",    type: "website",    siteName: "Columbia School O'quv Markazi",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/young-teen-girls-study-desk-attending-virtual-webinar-class_482257-123130.jpg",        alt: "Columbia School - Modern Ta'lim Markazi"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "Columbia School | Tashkent O'quv Markazi",    description: "Sifatli ta'lim, professional o'qituvchilar, muvaffaqiyyat garantiyasi.",    images: ["http://img.b2bpic.net/free-photo/young-teen-girls-study-desk-attending-virtual-webinar-class_482257-123130.jpg"],
  },
};
